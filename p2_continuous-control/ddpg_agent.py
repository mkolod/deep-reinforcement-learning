...
class Agent():
    def __init__(self, 
        ...
        # Critic Network
        self.critic_local = Critic(state_size, action_size, leak=relu_leak, seed=seed).to(self.device)
        self.critic_target = Critic(state_size, action_size, leak=relu_leak, seed=seed).to(self.device)
